...
describe('renderCell', () => {
  test('plain text when no view and a scalar type', () => {
    expect(renderCell('id', '7', {}, row, columns, { id: 'UInt64' })).toBe('7')
  })

  test('complex types get the built-in view unless a cell view overrides', () => {
